...
function Page({ params }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://my-home-et-al-backend-u0m7.onrender.com/api/v1/admin/${params.id}`,
        {
          method: "DELETE",
          headers: {
  ...
  const Deactivate = async () => {
    ...
    try {
      const response = await fetch(
        `https://my-home-et-al-backend-u0m7.onrender.com/api/v1/admin/deactivate/${params.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  const Activate = async () => {
    ...
    try {
      const response = await fetch(
        `https://my-home-et-al-backend-u0m7.onrender.com/api/v1/admin/activate/${params.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
