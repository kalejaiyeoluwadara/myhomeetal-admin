...
function Page({ params }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `server.myhomeetal.store/api/v1/admin/${params.id}`,
        {
          method: "DELETE",
          headers: {
  ...
  const Deactivate = async () => {
    ...
    try {
      const response = await fetch(
        `server.myhomeetal.store/api/v1/admin/deactivate/${params.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  const Activate = async () => {
    ...
    try {
      const response = await fetch(
        `server.myhomeetal.store/api/v1/admin/activate/${params.id}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
